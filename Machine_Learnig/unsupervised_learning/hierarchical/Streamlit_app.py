...
def load_model():
    ...
    try:
        model = joblib.load("hierarchical_model_cluster.pkl")
        return model
...
if model is not None and df is not None:
    ...
    if st.button("🚀 Predict Cluster", use_container_width=True, key="predict_btn"):
        ...
        with col2_info:
            ...
            clustered_data = pd.read_csv("hierarchical_clusters.csv")
        ...
        with viz_col1:
            ...
            clustered_df = pd.read_csv("hierarchical_clusters.csv")
