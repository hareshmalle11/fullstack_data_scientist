"""Streamlit app to predict rain or no rain using a saved AdaBoost model."""
import os
...
MODEL_PATH = "adaboost_rain_model.pkl"
...
st.set_page_config(page_title="Rain Prediction (AdaBoost)", layout="centered")
st.title("Rain Prediction - AdaBoost Classifier")
st.write("Predict rain or no rain from weather features.")

model = load_model()
if model is None:
    st.error("Model file not found. Train and save adaboost_rain_model.pkl in this folder.")
    st.stop()
