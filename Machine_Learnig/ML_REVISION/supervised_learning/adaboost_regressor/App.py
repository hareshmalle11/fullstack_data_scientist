"""Streamlit app to predict insurance charges using a saved AdaBoost model."""
import os
...
MODEL_PATH = "adaboost_insurance_model.pkl"
...
st.set_page_config(page_title="Insurance Charges Predictor (AdaBoost)", layout="centered")
st.title("Insurance Charges Predictor - AdaBoost Regressor")
st.write("Predict insurance charges from customer details.")

model = load_model()
if model is None:
    st.error("Model file not found. Train and save adaboost_insurance_model.pkl in this folder.")
    st.stop()
